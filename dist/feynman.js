...
},{"./particles/Electron":12,"./particles/Ghost":13,"./particles/Gluon":14,"./particles/Photon":15}],2:[function(require,module,exports){
...
module.exports = {
  ...
  draw: function(canvas, options) {
    ...
    this._drawArrow(ui, position.l, options.color ? options.color : _defaults.color);
  ...
  getPath: function(shape, options, tension) {
    ...
    switch(shape) {
      case 'line':
        return Bezier.line(tile, 1, length);
      case 'arc':
        return Bezier.arc('ghost', tile, 1, length, tension);
      case 'loop':
        return Bezier.loop('ghost', tile, 1, length);
      default:
        return Bezier.line(tile, 1, length);
    }
  },
...
},{"./../helpers/Array":4,"./../helpers/Bezier":5,"./../helpers/Label":7,"./../helpers/Point":8}],15:[function(require,module,exports){
var PointHelper = require('./../helpers/Point');
var ArrayHelper = require('./../helpers/Array');
var Bezier      = require('./../helpers/Bezier');
var Label       = require('./../helpers/Label');
